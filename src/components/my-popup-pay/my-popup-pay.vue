...
<template>
  <view class="pay">
    <u-popup :show="isPopupPay" round="40" :close-on-click-overlay="true" @close="closePopupPay">
      <view class="m-popup__pay">
        ...
        <view class="pay-radiogroup">
          ...
          <view class="pay-radiogroup__radio" @click="radioPayOption = 'wxPay'">
            <image class="pay-radiogroup__radio-wx" :src="vipIconWx" />
            <u-icon name="checkmark-circle-fill" color="#5C68DA" size="40" />
        ...
        <view class="pay-submit" @click="handlePay">
          确定
        </view>
      </view>
    </u-popup>
