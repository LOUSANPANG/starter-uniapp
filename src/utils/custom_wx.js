 ...
 */
import wx from '@/js_sdk/jweixin-1.6.0.js'
...
export function getWxCode(url) {
  ...
  let local = url || window.location.href
...
export async function configWxApi(url, jsApiList, fn) {
 ...
 */
export async function isFollowGzh() {
  let isReturn = true
